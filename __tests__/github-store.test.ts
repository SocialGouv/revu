...
import {} from '../src/platforms/github/reviewer-utils.ts'
...
describe('GithubStore', () => {
  describe('isReviewRequestedForBot', () => {
    ...
    it('should correctly detect review requests for the bot', () => {
      ...
      expect(sut.isReviewRequestedForBot('revu-bot[bot]')).toBe(true)
    })
    ...
    it('should ignore review requests for other reviewers', () => {
      ...
      expect(sut.isReviewRequestedForBot('revu-bot[bot]')).toBe(false)
    })
