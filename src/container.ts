...
if (PROVIDER === 'github') {
  const platformService = new PlatformService(process.env.PROXY_REVIEWER_USERNAME)
  container.registerInstance<WebhookApp>('WebhookApp', await GithubWebhookApp.create(platformService))
